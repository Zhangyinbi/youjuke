...
public class DownLoadService extends Service {
    ...
    private String destFileDir = Environment.getExternalStorageDirectory().getAbsolutePath() + File
            .separator + "BuildingMaterialMall";
    /**
     * 目标文件存储的文件名
     */
    private String destFileName = "BuildingMaterialMall.apk";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        destFileName = "BuildingMaterialMall"+versionName+".apk";
    ...
    public void initNotification() {
        builder = new NotificationCompat.Builder(mContext)
                ...
                .setContentText("0%")
                .setContentTitle(mContext.getString(R.string.app_name)+"更新")
