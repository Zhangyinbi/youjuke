package com.youjuke.swissgearlibrary.widgets;
 ...
 * --------------------------------------------
 * 工程:
 * #0000     mwy     创建日期: 2016-09-18 20:40
 */
public class LazyViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        /** * This method will be invoked when a new page becomes selected. * Animation is not necessarily complete. * * @param position * Position index of the new selected page. */
    ...
    /** * Simple implementation of the * {@link com.bxg.news.view.LazyViewPager.OnPageChangeListener} * interface with stub implementations of each method. Extend this if you do * not intend to override every method of * {@link com.bxg.news.view.LazyViewPager.OnPageChangeListener}. */
    ...
    /** * Returns the number of pages that will be retained to either side of the * current page in the view hierarchy in an idle state. Defaults to 1. * * @return How many pages will be kept offscreen on either side * @see #setOffscreenPageLimit(int) */
    ...
    /** * Set the margin between pages. * * @param marginPixels * Distance between adjacent pages in pixels * @see #getPageMargin() * @see #setPageMarginDrawable(android.graphics.drawable.Drawable) * @see #setPageMarginDrawable(int) */
    ...
    /** * Set a drawable that will be used to fill the margin between pages. * * @param d * Drawable to display between pages */
    ...
    /** * Set a drawable that will be used to fill the margin between pages. * * @param resId * Resource ID of a drawable to display between pages */
    ...
    /** * Like {@link android.view.View#scrollBy}, but scroll smoothly instead of * immediately. * * @param x * the number of pixels to scroll by on the X axis * @param y * the number of pixels to scroll by on the Y axis */
    void smoothScrollTo(int x, int y) {
        smoothScrollTo(x, y, 0);
    }

    /** * Like {@link android.view.View#scrollBy}, but scroll smoothly instead of * immediately. * * @param x * the number of pixels to scroll by on the X axis * @param y * the number of pixels to scroll by on the Y axis * @param velocity * the velocity associated with a fling, if applicable. (0 * otherwise) */
    ...
    /** * Fake drag by an offset in pixels. You must have called * {@link #beginFakeDrag()} first. * * @param xOffset * Offset in pixels to drag by. * @see #beginFakeDrag() * @see #endFakeDrag() */
    ...
    /** * Returns true if a fake drag is in progress. * * @return true if currently in a fake drag, false otherwise. * * @see #beginFakeDrag() * @see #fakeDragBy(float) * @see #endFakeDrag() */
