...
public class OutComeFragment extends BaseFragment{
    ...
    public OutComeFragment(BalanceDetailActivity balanceDetailActivity) {
        super();
    ...
    private void initView() {
        ...
        adapter=new DetailAdapter(mContext,datas,1);
                ...
                .subscribe(new Subscriber<ResponseBean>() {
                    ...
                    public void onNext(ResponseBean responseBean) {
                        ...
                        if ("200".equals(responseBean.getStatus())) {
                            ...
                            tvHintContent.setText(R.string.no_out_detail);
                            tvHintContent.setVisibility(View.VISIBLE);
                            ivNoDetail.setVisibility(View.VISIBLE);
                        }
                    }
