package com.youjuke.buildingmaterialmall.widgets.CircleIndicator;
...
public class CircleIndicator extends LinearLayout {
    ...
    private int mIndicatorBackgroundResId = R.drawable.lead_radius;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.lead_radius;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.lead_radius, R.drawable.lead_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.lead_radius
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
